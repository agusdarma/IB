...
//
//public class CreateIdBillingApprovalAction extends BaseListAction implements ModuleCheckable {
//	private static final long serialVersionUID = 1L;
//	private static final Logger LOG = LoggerFactory.getLogger(CreateIdBillingApprovalAction.class);
//
//	@Autowired
...
//			int[] listStatus = {
//				WebConstants.PAJAK_DIST_STATUS_PARTIAL_FIN, WebConstants.PAJAK_DIST_STATUS_CALLBACK
//			};
...
//				throw new SambaWebException(SambaWebException.NE_INVALID_SYSLOGNO);
//			}
//			if (header.getStatus() != WebConstants.PAJAK_DIST_STATUS_PARTIAL_FIN &&
...
//		LOG.debug("Verify Inq with processType: {}, remarks {}, otp {}", processType, remarks, otp);
//		try {
//			UserDataLoginVO loginVO = (UserDataLoginVO) session.get(LOGIN_KEY);
//			getHeader().setApprovalRemarks(remarks);
//			if ("PROCESS".equalsIgnoreCase(processType))
//				getHeader().setStatus(WebConstants.PAJAK_DIST_STATUS_APPROVED);
//			else if ("REJECT".equalsIgnoreCase(processType))
//				getHeader().setStatus(WebConstants.PAJAK_DIST_STATUS_REJECTED_APPROVAL);
//			else {
//				LOG.warn("Unknown type " + processType);
//				throw new SambaWebException(SambaWebException.NE_INVALID_INPUT);
//			}
//			Map<String, Object> MapBit48 = new HashMap<String, Object>();
//			MapBit48 = distMoneyService.verifyDistApprovalPajak(loginVO, getHeader(), getListDetail(), otp,WebConstants.INQ);
//			LOG.debug("MapBit48 put: {}", MapBit48);
//			session.put(BIT48, MapBit48.get(WebConstants.WEB_PARAM_BIT48_KEY));
//			String temp = "";
//			Object o = session.get(BIT48);
...
//		LOG.debug("Verify Sett with processType: {}, remarks {}, otp {}", processType, remarks, otp);
//		try {
//			UserDataLoginVO loginVO = (UserDataLoginVO) session.get(LOGIN_KEY);
//			getHeader().setApprovalRemarks(remarks);
//			if ("PROCESS".equalsIgnoreCase(processType))
...
//			List<DistributionDetail> listDetail = getListDetail();
//			for (DistributionDetail distributionDetail : listDetail) {
//				distributionDetail.setBit48(bit48);
//				LOG.debug("distributionDetail: {}", distributionDetail);
//			}
//			LOG.debug("listDetail: {}", listDetail);
//			DistributionHeader header = getHeader();
//			header.setBit48(bit48);
//			distMoneyService.verifyDistApprovalPajak(loginVO, header, listDetail, otp,WebConstants.SETT);
//			return SUCCESS;
//		} catch (SambaWebException fae) {
////			LOG.warn("SambaWebException", fae);
//			WebResultVO wrv = handleJsonException(fae);
...
//		return WebModules.MODULE_APPS_OPERATIONAL_CREATE_ID_BILLING_APPROVAL;
//	}
//	
//	public String otp() {
//		UserDataLoginVO loginVO = (UserDataLoginVO) session.get(LOGIN_KEY);
