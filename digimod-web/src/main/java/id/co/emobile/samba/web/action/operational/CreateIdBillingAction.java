...
//
//public class CreateIdBillingAction extends BaseListAction implements ModuleCheckable {
//	private static final long serialVersionUID = 1L;
//	private static final Logger LOG = LoggerFactory.getLogger(CreateIdBillingAction.class);
//
//	@Autowired
...
//		return WebModules.MODULE_APPS_OPERATIONAL_CREATE_ID_BILLING;
//	}
//
...
//				+ "jumlah Setor {},sracid {},uraianSsp {},npwpPenyetor {},noSk {},kodeKkpSsp {},nop {}", CommonUtil.convertNumericFormatToString(npwpSsp), nama, alamat,
//				fileAssignmentFileName, remarks, jenisPajak, jenisSetoran, startDatePbb, endDatePbb, tahunPajak,
//				CommonUtil.convertNumericFormatToString(jumlahSetor), sracId, uraianSsp, CommonUtil.convertNumericFormatToString(npwpPenyetor), CommonUtil.convertNumericFormatToString(noSk),
//				CommonUtil.convertNumericFormatToString(nop),CommonUtil.convertNumericFormatToString(nop));
//		try {
//			UserDataLoginVO loginVO = (UserDataLoginVO) session.get(LOGIN_KEY);
//			distMakerVO = distMoneyService.processCreateIdBilling(loginVO.getUserCode(), CommonUtil.convertNumericFormatToString(npwpSsp), nama, alamat, remarks,
//					fileAssignmentFileName, fileAssignment, jenisPajak, jenisSetoran, startDatePbb, endDatePbb,
...
//					CommonUtil.convertNumericFormatToString(noSk), CommonUtil.convertNumericFormatToString(nop), "", false,"");
