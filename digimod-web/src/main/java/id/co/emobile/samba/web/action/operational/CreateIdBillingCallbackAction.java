...
//
//public class CreateIdBillingCallbackAction extends BaseListAction implements ModuleCheckable {
//	private static final long serialVersionUID = 1L;
//	private static final Logger LOG = LoggerFactory.getLogger(CreateIdBillingCallbackAction.class);
//
//	@Autowired
...
//		listHeader = distMoneyService.findDistHeaderByGroupAndStatus(loginVO.getGroupId(), WebConstants.PAJAK_DIST_STATUS_CHECKED);
//		return INPUT;
//	}
//	
...
//				getHeader().setStatus(WebConstants.PAJAK_DIST_STATUS_CALLBACK);
//			else if ("REJECT".equalsIgnoreCase(processType))
//				getHeader().setStatus(WebConstants.PAJAK_DIST_STATUS_REJECTED_CALLBACK);
//			else {
...
//		return WebModules.MODULE_APPS_OPERATIONAL_CREATE_ID_BILLING_CALLBACK;
//	}
//	
//	public String otp() {
//		UserDataLoginVO loginVO = (UserDataLoginVO) session.get(LOGIN_KEY);
