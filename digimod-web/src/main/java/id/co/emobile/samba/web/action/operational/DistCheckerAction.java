...
//
//public class DistCheckerAction extends BaseListAction implements ModuleCheckable {
//	private static final long serialVersionUID = 1L;
//	private static final Logger LOG = LoggerFactory.getLogger(DistCheckerAction.class);
//
//	@Autowired
...
//		listHeader = distMoneyService.findDistHeaderByGroupAndStatus(loginVO.getGroupId(), WebConstants.DIST_STATUS_UPLOADED);
//		return INPUT;
//	}
//	
...
//				throw new SambaWebException(SambaWebException.NE_INVALID_SYSLOGNO);
//			}
//			if (header.getStatus() != WebConstants.DIST_STATUS_UPLOADED) {
...
//				getHeader().setStatus(WebConstants.DIST_STATUS_CHECKED);
//			else if ("REJECT".equalsIgnoreCase(processType))
//				getHeader().setStatus(WebConstants.DIST_STATUS_REJECTED_CHECKER);
//			else {
...
//		return WebModules.MODULE_APPS_OPERATIONAL_DIST_CHECKER;
//	}
//	
//	public String otp() {
//		UserDataLoginVO loginVO = (UserDataLoginVO) session.get(LOGIN_KEY);
