...
<head>
	...
	<title>List Member - NabungDividen</title>
		<!-- JAVA SCRIPT -->
		<s:url var="remoteurl" action="ManageMember!processInput"/>
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow">
                <%-- <div class="row mt-4 ml-3">
                  <div class="col">
                    <s:a cssClass="btn bg-green text-white" action="ManageMember!gotoInput" >
                ...
                <div class="card shadow mx-4 my-4">
                  <div class="card-header bg-blue border-blue">
                    <h6 class="m-0 font-weight-bold text-white">List Member Account</h6>
                  </div>
