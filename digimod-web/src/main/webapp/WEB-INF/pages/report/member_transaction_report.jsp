...
<head>
	...
	<title>NabungDividen - Laporan Transaksi Member</title>
	<s:url var="exportReport" action="MemberTransactionReport!exportReport" />
              ...
              <s:property value="message" />
                ...
                <div class="card shadow mx-4 my-4">
                  <div class="card-header bg-blue border-blue">
                    <h6 class="m-0 font-weight-bold text-white">Laporan Transaksi Member</h6>
                  </div>

                  <s:form id="form1" action="MemberTransactionReport!processSearch">
                  ...
                  <div class="row d-flex justify-content-center my-4">
	                   <div class="card mx-4 my-4 col-8 border-blue">                
	                  	<div class="my-4 mx-4">
							...
							<div class="form-group row">
								<label for="example-date-input" class="col-2 col-form-label">Member</label>
								<div class="col-9">
