...
<html>
	<head>
		...
		<!-- JAVA SCRIPT -->
		<s:url var="remoteurl" action="Merchant!processInputNoBiller"/>
                        ...
                        <s:actionerror /><s:actionmessage />
                       	<div class="FieldSetContainer">
                        	...
                        	<div class="form-group row">
	                        	<label for="merchantCode" class="col-sm-3 col-form-label"><s:text name="l.merchantCode" /><font color="red" size="1"><i><b>*)</b></i></font></label>
                        		<s:if test="merchant.id == 0">
	                        		<div class="col-sm-8">
										<s:textfield maxlength="16" type="text" id="merchantCode" name="merchant.merchantCode" cssClass="form-control" required="true"/>
									</div>
								</s:if>
								<s:else>
									<div class="col-sm-8">
										<s:textfield maxlength="16" type="text" id="merchantCode" name="merchant.merchantCode" cssClass="form-control" readOnly="true"/>
									</div>
								</s:else>
							</div>
                        	...
                        	<br>
                        	<div class="form-group row">
	                        	<label for="merchantName" class="col-sm-3 col-form-label"><s:text name="l.merchantName" /><font color="red" size="1"><i><b>*)</b></i></font></label>
                        		<div class="col-sm-8">
									<s:textfield maxlength="100" type="text" id="merchantName" name="merchant.merchantName" cssClass="form-control" required="required"/>
								</div>
							</div>
                        	
                        	<br>
                        	<div class="form-group row">
	                        	<label for="merchantStatus" class="col-sm-3 col-form-label"><s:text name="l.merchantStatus" /></label>
								<div class="col-sm-8">
                        	...
                        	<br>
                        	<div class="form-group row">
	                        	<label for="showOrder" class="col-sm-3 col-form-label"><s:text name="l.showOrder" /><font color="red" size="1"><i><b>*)</b></i></font></label>
	                        	<div class="col-sm-8">
                        	...
                        	<s:if test="merchant.id>0">
								<br>
								<div class="form-group row">
									<label for="'photo'" class="col-sm-3 col-form-label"><s:text name="l.existingLogo" /></label>
									<div class="col-sm-8">
                        	...
                        	<s:if test="checkPrevileges(menuId)">
	                        	<br>
	                        	<div class="form-group row">
		                        	<label for="merchantLogo" class="col-sm-3 col-form-label"><s:text name="l.merchantLogo" /></label>
		                        	<div class="col-sm-8">
		                        	...
		                        	<div class="col-sm-8">
		                        		<font size="1" color="red"> *Recommended merchant logo size 128x128 px</font>
		                        	</div>		                        	
	                        	</div>
                        	</s:if>
						</div>
