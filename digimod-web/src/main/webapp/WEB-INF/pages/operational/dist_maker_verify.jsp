...
<head>
    ...
    $(document).ready(function()
    {
		$("#sendOtp").click(function() {
			$.get( "<s:url action='DistMaker!otp' />" );
...
<body>
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" class="bg-gray">
		...
		<s:form action="DistMaker!verify" method="POST">
        <!-- Begin Page Content -->
          ...
          <div class="row">
			...
			<div class="alert alert-danger" role="alert">
              ...
              <div class="row ml-sm-3 my-4">
                ...
                <div class="col-lg-2">
                	<s:a action="DistMaker!back" cssClass="btn bg-red btn-lg text-white" cssStyle="text-align: left;">
