...
<body>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" class="bg-gray">
		...
		<s:form action="CreateIdBillingNonNpwp!process" method="POST" enctype="multipart/form-data">
        <!-- Begin Page Content -->
              ...
              <div class="card shadow">
                <div class="card-body">
                  <div class="card shadow bg-blue text-white mb-4">
                    <div class="card-body">
                      Create ID Billing Pajak Non NPWP
                    </div>
                  </div>
                  ...
                  <div class="row mx-2">
                    ...
                    <div class="col-lg-6"> 
					  <div class="card mb-4">
					  	...
					  	<div class="card-body">
					  	<label class="text-black"><b>Nama WP</b></label>
					  	<s:textfield type="text" id="namaWp" maxLength="30" name="namaWp" cssClass="form-control form-control-lg" required="true" />
					  	<label class="text-black"><b>Alamat WP</b></label>
					  	<s:textfield type="text" id="alamatWp" maxLength="50" name="alamatWp" cssClass="form-control form-control-lg" required="true" />
					  	<label class="text-black"><b>Nik</b></label>
					  	<s:textfield type="text" id="nik" maxLength="16" onfocus="this.select();" name="nik" cssClass="form-control form-control-lg" />
					  	<label class="text-black"><b>Kota WP</b></label>
					  	<s:textfield type="text" id="kotaWp" maxLength="30" name="kotaWp" cssClass="form-control form-control-lg" required="true" />					 					 
						...
						<label class="text-black"><b>Jumlah Setor</b></label>
					  	...
					  	<label class="text-black"><b>NPWP</b></label><br>
					  	000000000 <s:textfield type="text" id="npwpSsp" maxLength="3" onfocus="this.select();" name="npwpSsp" /> 000 <br>
					  	<label class="text-black"><b>NPWP Penyetor</b></label><br>
					  	<s:textfield type="text" id="npwpPenyetor" maxLength="15" value="000000000000000" onchange="javascript:formatNpwpGlobal('npwpPenyetor');" onKeyPress="return isNumberKey(event)" onfocus="this.select();" name="npwpPenyetor" cssClass="form-control form-control-lg" />
