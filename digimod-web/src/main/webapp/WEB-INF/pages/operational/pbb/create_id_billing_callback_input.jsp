              ...
              <s:property value="message" />
                ...
                <div class="card shadow mx-4 my-4">
                  <div class="card-header bg-blue border-blue">
                    <h6 class="m-0 font-weight-bold text-white">List Pending Distribution</h6>
                  </div>
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                          ...
                          <s:iterator value="listHeader">
                          	<tr>
                              <td>
                              	<s:url id="callbackDetail" action="CreateIdBillingCallback!detail">
                              		<s:param name="sysLogNo" value="sysLogNo" />
                              	</s:url>
                                <s:a href="%{callbackDetail}">
