...
<head>
    ...
    $(document).ready(function()
    {
		$("#sendOtp").click(function() {
			$.get( "<s:url action='DistCallback!otp' />" );
...
<body>
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" class="bg-gray">
		...
		<s:form action="DistCallback!verify" method="POST">
          ...
          <div class="row">
			...
			<div class="alert alert-danger" role="alert">
              ...
              <div class="row ml-sm-3 my-4">
                ...
                <div class="col-lg-2">
                	<s:a action="DistCallback!back" cssClass="btn bg-red btn-lg text-white" cssStyle="text-align: left;">
