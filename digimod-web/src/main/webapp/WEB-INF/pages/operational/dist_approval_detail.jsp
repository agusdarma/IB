...
<s:iterator value="listDetail">
    ...
    $(document).ready(function()
    {
		$("#sendOtp").click(function() {
			$.get( "<s:url action='DistApproval!otp' />" );
...
<body>
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" class="bg-gray">
		...
		<s:form action="DistApproval!verify" method="POST">
          ...
          <div class="row">
			...
			<div class="alert alert-danger" role="alert">
              ...
              <div class="row ml-sm-3 my-4">
                ...
                <div class="col-lg-2">
                	<s:a action="DistApproval!back" cssClass="btn bg-red btn-lg text-white" cssStyle="text-align: left;">
...
<div class="modal fade" id="dialogStatus" tabindex="-1" role="dialog" aria-labelledby="dialogStatusTitle" aria-hidden="true">
  ...
  <div class="container-fluid">
  	<s:form id="formStatus" action="DistApproval!processStatus">
