...
<body>
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content" class="bg-gray">
		...
		<s:form action="DistMakerOther!process" method="POST" enctype="multipart/form-data">
        <!-- Begin Page Content -->
                    ...
                    <div class="col-lg-6"> 
					  <div class="card mb-4">
					  	<div class="card-header bg-green ">
					  		<label class="text-white"><b><i class="fas fa-file-csv"></i> Transfer Antar Bank</b></label>
					  	</div>
					  	<div class="card-body">
					  		<label class="text-black"><b>Kode Bank</b></label>
                          <s:select id="kodeBank" name="kodeBank" cssClass="form-control" list="listBankCode" listKey="lookupValue" listValue="lookupDesc" />
                          <label class="text-black"><b>No Rekening Tujuan</b></label>
					  	<s:textfield  maxlength="32" type="text" id="dsac" name="dsac" cssClass="form-control form-control-lg" required="true" />
					  	<label class="text-black"><b>Nama Rekening Tujuan</b></label>
					  	<s:textfield type="text" id="dsacName" name="dsacName" cssClass="form-control form-control-lg" required="true" />
					  	<label class="text-black"><b>Phone No</b></label>
					  	<s:textfield type="text" id="phoneNo" name="phoneNo" cssClass="form-control form-control-lg" required="true" />
					  	<label class="text-black"><b>Nominal</b></label>
					  	<s:textfield type="text" id="nominal" name="nominal" cssClass="form-control form-control-lg" required="true" />
					  	</div>
