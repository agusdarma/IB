...
public abstract class SddIsoMsg {
	private static final Logger LOG = LoggerFactory.getLogger(SddIsoMsg.class);
	...
	public static final int ADDITIONAL_DATA_5 = 47;
	...
	private SddIsoMsgHeader header;
	...
	protected static SddIsoMsg createISOMsg(SddIsoMsgHeader header) {
	...
	public SddIsoMsg(SddIsoMsgHeader header) {
		this.header = header;
		readPosition = 0;
		primaryBitmap = new BitSet();
		secondaryBitmap = new BitSet();
	...
	public SddIsoMsg parse(String rawMessage) {
		try {
	...
	public void setHeader(SddIsoMsgHeader header) {
		this.header = header;
	}
