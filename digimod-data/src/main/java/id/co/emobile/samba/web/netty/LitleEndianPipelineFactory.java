...
public class LitleEndianPipelineFactory implements BasePipelineFactory {
...
class LitleEndianFrameDecoder extends FrameDecoder {
	@Override
...
@ChannelHandler.Sharable
class LitleEndianOneToOneEncoder extends OneToOneEncoder {
	@Override
