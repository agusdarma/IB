...
public class MayapadaPipelineFactory implements BasePipelineFactory{
	private static final Logger LOGGER = LoggerFactory.getLogger(MayapadaPipelineFactory.class);
