...
public abstract class IsoMsg {
	private static final Logger LOG = LoggerFactory.getLogger(IsoMsg.class);
	...
	protected static IsoMsg createISOMsg(IsoMsgHeader header) {
	...
	public IsoMsg(IsoMsgHeader header) {
		this.header = header;
		readPosition = 0;
		primaryBitmap = new BitSet();
		secondaryBitmap = new BitSet();
	...
	public IsoMsg parse(String rawMessage) {
		try {
	...
	public void setHeader(IsoMsgHeader header) {
		this.header = header;
	}
