...
public class TrxLogD implements java.io.Serializable {
	...
	private String channelInputType;
	private String channelOutputType;
	...
	public String getChannelInputType() {
		return channelInputType;
	}
	public void setChannelInputType(String channelInputType) {
		this.channelInputType = channelInputType;
	}
	public String getChannelOutputType() {
		return channelOutputType;
	}
	public void setChannelOutputType(String channelOutputType) {
		this.channelOutputType = channelOutputType;
	}
}
