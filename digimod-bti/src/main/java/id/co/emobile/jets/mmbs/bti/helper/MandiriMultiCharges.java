 ...
 */
public class MandiriMultiCharges {
	private static final Logger LOG = LoggerFactory.getLogger(MandiriMultiCharges.class);
	...
	public MandiriMultiCharges(SortedSet<FundFlowVO> fundFlows) throws JetsException {
		parse(fundFlows);
	}
